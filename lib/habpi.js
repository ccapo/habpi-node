...
module.exports.HABPi = class HABPi {
  constructor(options) {
    ...
    this.db = new Sequelize('habpi', null, null, {
      ...
      retry: {max: 5, match: [new RegExp('SQLITE_BUSY'), new RegExp('SequelizeTimeoutError'), new RegExp('Unhandled rejection'), Sequelize.TimeoutError, Sequelize.ConnectionError]},
      benchmark: false
    });
