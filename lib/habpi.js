...
module.exports.HABPi = class HABPi {
  constructor(options) {
    ...
    this.db = new Sequelize('habpi', null, null, {
      ...
      transaction: Sequelize.Transaction.TYPES.DEFERRED, // DEFERRED, IMMEDIATE, EXCLUSIVE
      ...
      retry: {max: 5, match: [new RegExp('SQLITE_BUSY'), Error, Sequelize.TimeoutError, Sequelize.ConnectionError]},
      benchmark: false
    });
